    ...
    if (!this.pdfViewer.currentScaleValue) {
      this.pdfViewer.currentScaleValue = _ui_utils.DEFAULT_SCALE_VALUE;
		...
		if(c_url.indexOf("&")&&c_url.indexOf("=")){
			...
			// document.getElementById('customScaleOption').textContent = '200%';
			// document.getElementById('customScaleOption').selected  = true;
		}
  },
...
var PDFLinkService = function () {
  ...
  _createClass(PDFLinkService, [{
    ...
    value: function _cachedPageNumber(pageRef) {
      ...
      var refStr = pageRef.num + ' ' + pageRef.gen + ' R';
		/* 	console.log("传过来的参数："+refStr);
			console.log("返回值为："+(this._pagesRefCache && this._pagesRefCache[refStr] || null));
		//	console.log("第一个参数："+this._pagesRefCache);
		console.log("第二个参数（后）："+this._pagesRefCache[refStr]); */
    ...
    value: function update() {
      ...
      var visiblePages = visible.views,
          numVisiblePages = visiblePages.length;
				//	console.log("::"+visible+"::"+visiblePages+"::"+numVisiblePages)
	...
	//console.log("当前页码："+pageNumber+"当前参数"+pdfOpenParams)
      this._location = {
        ...
        pdfOpenParams: pdfOpenParams
			...
			//console.log("当前页码对应的编码值："+JSON.stringify(page_cache))
			//给页面赋值
